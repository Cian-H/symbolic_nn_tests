...
- Training loss
![Training loss plot for experiment 3](./results/Experiment3/train_loss.png)
- Validation loss
![Validation loss plot for experiment 3](./results/Experiment3/val_loss.png)
- Test loss
![Test loss plot for experiment 3](./results/Experiment3/test_loss.png)
